...
BOT_TOKEN = environ.get('BOT_TOKEN', '8386499641:AAF6r7UlrilouT4uw72-ID1pJONEIpcvhZI')  # Telegram Bot Token
...
BOT_USERNAME = environ.get("BOT_USERNAME", 'Kartikashpurbot')  # Bot's username
